...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'org-block-begin-line nil :underline nil :overline nil :foreground "#008ED1" :background "0")
  (set-face-attribute 'org-block-end-line nil :underline nil :overline nil :foreground "#008ED1" :background "0")
    ...
    (custom-theme-set-faces
     'user
     '(variable-pitch ((t (:family "ETbb" :height 120 :weight thin))))
